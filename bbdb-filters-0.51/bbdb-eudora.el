...
;;;
;;; 
;;; RCS: $Id: bbdb-eudora.el,v 1.1.1.1 2007/02/23 22:32:57 mohsen Exp $
;;;
...
(defun bbdb-output-eudora-nndbase (to-file)
...
(defun bbdb-output-eudora-rcpdbase (to-file)
  "Print the selected BBDB entries"
